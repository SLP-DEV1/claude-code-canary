...
const commands = String.raw`program.command('pr-check')
...
`;
await replaceOnce('src/index.ts', "program.command('experiment')", `${commands}program.command('experiment')`);
